...
// TO DO: Parameterize the Widget completely

function load_ace(title, div, par){
    console.log("load_ace : " + title + " to <div>" + div + "</div>");

    // Define widget object & local variables here
    var editor = ace.edit("editor");
    editor.setTheme("ace/theme/monokai");
    editor.getSession().setMode("ace/mode/javascript");      

    // Widget Param Editor (opens another TAB with designated Editor/widget)
    var widgetParamEditorCall = 'load_ace()'; // point to other widget

    // MOVE THESE TO WIDGETUTILS.JS
    ...
    // ##### WIDGET PARAMS EDITOR Meta #####
    // ADD MORE WIDGET EDITOR SPECIFICS
    // ### STORE IN GLOBAL-WIDGET-Space on/off-line
